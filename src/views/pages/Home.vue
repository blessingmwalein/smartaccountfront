        ...
        <div class="banner-wrapper author-notification">
            <div class="container inner-wrapper">
                ...
                <div class="dz-media media-45 rounded-circle">
                    <a href="profile.html"><img src="assets/images/author/pic1.png" class="rounded-circle"
                            alt="author-image"></a>
                </div>
            </div>
        </div>
                        ...
                        <div class="list item-list recent-jobs-list">
                            <ul>
                                <li>
                                    <div class="item-content">
                                        <a href="job-detail.html" class="item-media"><img
                                                src="assets/images/logo/company-logo1.png" width="55" alt="logo"></a>
                                        <div class="item-inner">
                                            <div class="item-title-row">
                                                <div class="item-subtitle">Highspeed Studios</div>
                                                <h6 class="item-title"><a href="job-detail.html">Software Engineer</a>
                                                </h6>
                                            </div>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <svg class="text-primary" width="20" height="20" viewBox="0 0 20 20"
                                ...
                                <li>
                                    <div class="item-content">
                                        <a href="job-detail.html" class="item-media"><img
                                                src="assets/images/logo/company-logo2.png" width="55" alt="logo"></a>
                                        <div class="item-inner">
                                            <div class="item-title-row">
                                                <div class="item-subtitle">Lunar Djaja Corp.</div>
                                                <h6 class="item-title"><a href="job-detail.html">Database Engineer</a>
                                                </h6>
                                            </div>
                                            <div class="d-flex align-items-center mb-2">
                                                <svg class="text-primary" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <li>
                                    <div class="item-content">
                                        <a href="job-detail.html" class="item-media"><img
                                                src="assets/images/logo/company-logo3.png" width="55" alt="logo"></a>
                                        <div class="item-inner">
                                            <div class="item-title-row">
                                                <div class="item-subtitle">Highspeed Studios</div>
                                                <h6 class="item-title"><a href="job-detail.html">Software Engineer</a>
